...
if ( name == null && surname == null && am == null && email == null && department == null ) {
    ...
    throw new Exception("No parameters specified, please visit <a href='addstudent_lesson6.jsp'>registration form</a>");
...
request.setAttribute("successMessage", "Student with am: " + student.getAm() + " saved successfully!");
%>
